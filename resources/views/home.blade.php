  ...
  <form method="POST" action="{{ route('register-company') }}">
    ...
    <div class="" id="step-1">
      ...
      <div class="form-group">
        <input type="text" placeholder="Enter your name" id="company_admin" name="company_admin" required>
      </div>
      <div class="form-group">
        <input type="email" placeholder="Email" id="company_email" name="company_email" required>
      </div>
      <div class="form-group">
    ...
    <div class="" id="step-3">
      ...
      <div class="form-group checkbox">
        ...
        <label for="condition">I agree to <a href="#" target="_blank">Usage Terms</a></label> --}}
      </div>
